	...
	<div class="d-flex align-items-center slider1" id="home">
		<div class="container">
			<div class="row">
	...
	<!--==================================================-->
<!-- 	
	<div class="team_area pt-80 pb-75" style="background: linear-gradient(175deg, rgba(239,242,247,1) 0%, rgba(255,255,255,1) 100%);" >
		<div class="container">
			<div class="row">
				<div class="col-lg-9">
			...
			<div class="row" style="justify-content: space-evenly;">
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="single_team mb-4">
						<div class="single_team_thumb">
							<img src="assets/images/team_jesus.jpg" alt="foto jesús" />
						...
						<div class="single_team_content">
							<h4><a href="file:///Users/macniacos/Desktop/webelayu/team_jesus.html">Jesús Gordillo</a></h4>
							<span>CEO</span>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="single_team mb-4">
						<div class="single_team_thumb">
							<img src="assets/images/team_alba.jpg" alt="foto alba" />
							<div class="single_team_icon">
						...
						<div class="single_team_content">
							<h4><a href="file:///Users/macniacos/Desktop/webelayu/team_alba.html">Alba Ortega</a></h4>
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="single_team mb-4">
						<div class="single_team_thumb">
							<img src="assets/images/team_jose.jpg" alt="foto jose" />
							<div class="single_team_icon">
						...
						<div class="single_team_content">
							<h4><a href="file:///Users/macniacos/Desktop/webelayu/team_jose.html">Jose Díez</a></h4>
			...
			<div class="row" style="justify-content: space-evenly;">
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="single_team mb-4">
						<div class="single_team_thumb">
							<img src="assets/images/team_juanma.jpg" alt="foto juanma" />
							<div class="single_team_icon">
						...
						<div class="single_team_content">
							<h4><a href="file:///Users/macniacos/Desktop/webelayu/team_juanma.html">Juanma Cantero</a></h4>
				...
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="single_team mb-4">
						<div class="single_team_thumb">
							<img src="assets/images/team_fredo.jpg" alt="foto fredo" />
							<div class="single_team_icon">
						...
						<div class="single_team_content">
							<h4><a href="file:///Users/macniacos/Desktop/webelayu/team_alfredo.html">Alfredo Tapia</a></h4>
							<span>Diseño & Artes Gráficas</span>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12">
					<div class="single_team mb-4">
						<div class="single_team_thumb">
							<img src="assets/images/team_juan.jpg" alt="foto juan" />
							<div class="single_team_icon">
						...
						<div class="single_team_content">
							<h4><a href="file:///Users/macniacos/Desktop/webelayu/team_juan.html">Juan Antonio Rodríguez</a></h4>
							<span>Tecnología & Informática</span>
						</div>
					</div>
				</div>
...
-->		
	...
	<!--==================================================-->
	<div class="how_it_work pt-50 pb-65" style="background: linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(239,242,247,1) 100%);">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
            ...
            <section id="section-quote">
                ...
                <div class="container-pe-quote left">
                    <div class="pp-quote li-quote-1" data-textquote="quote-text-1">
                        <div class="img animated bounce" style="background-image:url(assets/images/testi/1.png); background-color: #70b53c;"></div>
                    </div>
                    ...
                    <div class="pp-quote li-quote-6" data-textquote="quote-text-6">
                        <div class="img animated bounce" style="background-image:url(assets/images/testi/6.png); background-color: #70b53c;	"></div>
                    </div>
                </div>
                <!--Left Bubble Images-->
                <!--Center Testimonials-->
                <div class="container-quote carousel-on">
                    ...
                    <div class="quote hide-bottom quote-text-6" data-ppquote="li-quote-6">
                        ...
                        <div class="container-info">
                            <div class="pp" style="background-image:url(assets/images/testi/6.png); background-color: #70b53c;"></div>
                    ...
                    <div class="quote quote-text-1 hide-bottom" data-ppquote="li-quote-1">
                        <p>'Todos los logos que me han estaban deliciosos. Qué rico el departamento de Artes Gráficas.'</p>
                        <div class="container-info">
                            <div class="pp" style="background-image:url(assets/images/testi/1.png); background-color: #70b53c;"></div>
                            <div class="name">José Ramón Martínez</div>
                            <div class="job">La Puchera</div>
                        </div>
                    </div>
                    <!--Testimonial 12-->
		...
		<div class="row image_load">
				...
				<div class="single_portfolio">
					<div class="single_portfolio_inner">
						<div class="single_portfolio_thumb">
							<a href="file:///Users/macniacos/Desktop/webelayu/project_uno.html"><img src="assets/images/portfolio/p1.jpg" alt="" /></a>
						</div>
					</div>
					<div class="single_portfolio_content">
						<div class="single_portfolio_icon">
							<a class="portfolio-icon venobox vbox-item" data-gall="myportfolio" href="assets/images/portfolio/p1.jpg"><i class="fas fa-search-plus" style="background: #fff; height: 40px; width: 40px; text-align: center; line-height: 40px; font-size: 18px; border-radius: 5px; transition: .5s;"></i></a>
						</div>
						<div class="single_portfolio_content_inner">
							<span>Empresa de fisioterapia</span>
							<h2><a href="file:///Users/macniacos/Desktop/webelayu/project_uno.html">Grupo Giraldo</a></h2>
			...
			<div class="col-lg-4 col-md-6 col-sm-12 grid-item cemes">
				<div class="single_portfolio">
					...
					<div class="single_portfolio_content">
						<div class="single_portfolio_icon">
							<a class="portfolio-icon venobox vbox-item" data-gall="myportfolio" href="assets/images/portfolio/p2.jpg"><i class="fas fa-search-plus" style="background: #fff; height: 40px; width: 40px; text-align: center; line-height: 40px; font-size: 18px; border-radius: 5px; transition: .5s;"></i></a>
						</div>
						<div class="single_portfolio_content_inner">
			...
			<div class="col-lg-4 col-md-6 col-sm-12 grid-item cemes">
				<div class="single_portfolio">
					...
					<div class="single_portfolio_content">
						<div class="single_portfolio_icon">
							<a class="portfolio-icon venobox vbox-item" data-gall="myportfolio" href="assets/images/portfolio/p3.jpg"><i class="fas fa-search-plus" style="background: #fff; height: 40px; width: 40px; text-align: center; line-height: 40px; font-size: 18px; border-radius: 5px; transition: .5s;"></i></a>
						</div>
						<div class="single_portfolio_content_inner">
	...
	<div class="container" style="margin-bottom:80px; margin-top:40px;">
		<img src="assets\images\cero_icono.png" class="col-md-3 colab" height="50px">
		<img src="assets\images\cero_icono.png" class="col-md-3 colab" height="50px">
		<img src="assets\images\cero_icono.png" class="col-md-3 colab" height="50px">
		<img src="assets\images\cero_icono.png" class="col-md-3 colab" height="50px">
	</div>
